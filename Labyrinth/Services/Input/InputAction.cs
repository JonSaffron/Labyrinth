...
namespace Labyrinth.Services.Input
    ...
    public class InputAction
        ...
        public InputAction(Buttons[]? buttons, Keys[]? keys, bool newPressOnly)
            ...
            this._buttons = (buttons != null ? buttons.Clone() as Buttons[] : Array.Empty<Buttons>())!;
            this._keys = (keys != null ? keys.Clone() as Keys[] : Array.Empty<Keys>())!;
