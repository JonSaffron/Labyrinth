...
namespace Labyrinth.GameObjects
    ...
    public class StandardShot : MovingItem, IShot
        ...
        public StandardShot(AnimationPlayer animationPlayer, Vector2 position, Direction direction, int energy, StaticItem originator) : base(animationPlayer, position)
            {
